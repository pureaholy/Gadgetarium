...
public interface ProductRepository extends JpaRepository<Product, Long> {
    ...
    @Query("SELECT pro FROM Product pro WHERE pro.brand=:brand OR pro.color=:color OR pro.ram=:ram OR pro.rom=:rom")
    List<Product> filter(@Param("brand") Brand brand, @Param("color") Color color, @Param("ram") String ram, @Param("rom") String rom);
}